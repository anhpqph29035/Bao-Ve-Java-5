                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <div class="ms-4 mb-2 mt-2">
                                <a class="btn btn-success" href="/cua-hang/showaddcv">Thêm</a>
                            </div>
                            <table class="table align-items-center mb-0">
                                ...
                                <c:forEach items="${listCV}" var="u">
                                    <tr>
                                        ...
                                        <td>${u.ten}</td>
                                        <td>
                                            <a href="/cua-hang/detailcv/${u.id}" class="btn btn-primary">Chi Tiết</a>
                                            <a href="/cua-hang/deletecv/${u.id}" class="btn btn-danger"  onclick="return confirm('Bạn có muốn xóa không ?')">Xóa</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
