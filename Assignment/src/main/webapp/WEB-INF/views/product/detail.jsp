            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-4 pt-1 pb-2">
                            <%--@elvariable id="chh" type=""--%>
                            <form:form action="/cua-hang/updatesp/${chh.id}" modelAttribute="chh"  onsubmit="return confirm('Bạn có muốn sửa không ?')">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-danger text-start">${loiMSP}</p>
                                </div>
                                <div class="form-group">
                                    <label>Tên</label>
                                    <form:input class="form-control" path="ten"/>
                                    <p class="text-danger text-start">${loiTSP}</p>
                                </div>
