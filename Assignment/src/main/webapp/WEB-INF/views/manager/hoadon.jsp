...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Nhân Viên Đang Bán</p>
                                    <h5 class="fs-6 mb-0">
                                        ${tenNV}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Số Hóa Đơn Trong Ngày</p>
                                    <h5 class="fs-6 mb-0">
                                        ${soHD}
                                    </h5>
                                </div>
            ...
            <h5 class="mt-4">Lịch Sử Hóa Đơn</h5>
            <div class="col-xl-6 col-sm-4">
                <form action="/cua-hang/lochd" method="get">
            ...
            <div class="col-xl-6 col-sm-4 text-end">
                <form action="/cua-hang/timKiem" method="get">
                    <input type="text" name="maTim"  class="me-3">
            ...
            <table class="table table-striped mb-3">
                ...
                <tbody>
                <c:forEach items="${listHDTT}" var="c" varStatus="stt">
                    <tr>
                        <th scope="row">${stt.index+1}</th>
                        <th scope="row">${c.ma}</th>
                        <th scope="row">${c.nv.ten}</th>
                        <th scope="row">${c.kh.ten}</th>
                        <th scope="row">${c.ngayThanhToan}</th>
                        <th scope="row">
                            <a href="/cua-hang/hoadonct/${c.id}" class="btn btn-primary">Chi Tiết</a>
                        </th>
                    </tr>
                </c:forEach>
                </tbody>
